...
const CarRent = () => {
  return (
    <div className='border-bottom' style={{ padding: "120px 0px" }} >
      <div className="container">
        <div className="col-md-12 pb-4" >
          <span className='fw-bold text-start h2' style={{ color: "#0A2457" }}>Cars For Rent</span>
          <span className='float-end'>
            Show All Cars <span style={{ cursor: "pointer" }}><AiOutlinePlus className='plus ms-2' /></span>
          </span>
        </div>
                ...
                <div className='px-3'>
                  ...
                  <div className='py-3'>
                    <span className='text-secondary' style={{ fontSize: 13 }}>
                      <ImRoad size={14} /><span className='mx-2'>77362</span><span className='mx-3 ms-4'><GiGasPump size={18} /><span className='ms-2'>Diesel</span></span><span className='mx-2'> <IoMdGitNetwork size={16} /><span className='ms-2'>Automatic</span></span>
                    </span>
                  </div>
                </div>
              </div>
